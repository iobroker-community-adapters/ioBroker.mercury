...
var ff = {
    readSN:           function (device, index, cmd, response){
        console.log('readSN - index: ' + JSON.stringify(index) + ' response: ' + JSON.stringify(response) + ' lenght: ' + response.length);
    ...
    dateProd:         function (device, index, cmd, response){
        console.log('dateProd - index: ' + JSON.stringify(index) + ' response: ' + JSON.stringify(response) + ' lenght: ' + response.length);
        //{"type":"Buffer","data":[0,14,31,155,102,  37,1,18,  70,166]} lenght: 10 25 1 12
        setDevState(device, index, {
            name: 'info.dateProd',
            desc: 'Production date',
            val:  (response[5].toString(16) < 10 ? '0' :'') + response[5].toString(16) + '.' + (response[6].toString(16) < 10 ? '0' :'') + response[6].toString(16) + '.' + '20' + response[7].toString(16)
        });
        return device;
    },
    identCounter:     function (device, index, cmd, response){
        console.log('identCounter - index: ' + JSON.stringify(index) + ' response: ' + JSON.stringify(response) + ' lenght: ' + response.length);
        ...
        setDevState(device, index, {
            ...
            val:  (response[8].toString(16) < 10 ? '0' :'') + response[8].toString(16) + '.' + (response[9].toString(16) < 10 ? '0' :'') + response[9].toString(16) + '.' + '20' + (response[10].toString(16) < 10 ? '0' :'') + response[10].toString(16)
        });
        return device;
    },
    optronFunc:       function (device, index, cmd, response){
        console.log('optronFunc - index: ' + JSON.stringify(index) + ' response: ' + JSON.stringify(response) + ' lenght: ' + response.length);
    ...
    batteryVolt:      function (device, index, cmd, response){
        console.log('batteryVolt - index: ' + JSON.stringify(index) + ' response: ' + JSON.stringify(response) + ' lenght: ' + response.length);
