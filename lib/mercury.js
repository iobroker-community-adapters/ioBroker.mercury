...
const translate = function (w){ // PLEASE HELP WITH THE TRANSLATION
    ...
    if (word[w]){
        ...
        event.emit('info', 'Пожайлуста помогите с переводом - [ ' + '\'' + w + '\': {ru: \'' + 'ВАШ_ПЕРЕВОД\'' + ', en: \'' + 'YOUR_TRANSLATION\'}, ] PullRequest приветствуется, перевод нужно добавить в функцию translate - https://github.com/instalator/ioBroker.mercury/blob/6a99a51747b1cbf01661c3cf413714846e2c679d/lib/mercury.js#L6');
        return w;
    }
};
