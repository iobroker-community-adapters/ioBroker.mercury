...
function parseEnergy(response, devider){
    devider = devider || 1;
    return {
        t1: parseInt(response[5].toString(16) + response[6].toString(16) + response[7].toString(16) + (parseInt(response[8].toString(16)) < 10 ? ('0' + response[8].toString(16)) :response[8].toString(16))) / devider,
        t2: parseInt(response[9].toString(16) + response[10].toString(16) + response[11].toString(16) + (parseInt(response[12].toString(16)) < 10 ? ('0' + response[12].toString(16)) :response[12].toString(16))) / devider,
        t3: parseInt(response[13].toString(16) + response[14].toString(16) + response[15].toString(16) + (parseInt(response[16].toString(16)) < 10 ? ('0' + response[16].toString(16)) :response[16].toString(16))) / devider,
        t4: parseInt(response[17].toString(16) + response[18].toString(16) + response[19].toString(16) + (parseInt(response[20].toString(16)) < 10 ? ('0' + response[20].toString(16)) :response[20].toString(16))) / devider
    };
}
