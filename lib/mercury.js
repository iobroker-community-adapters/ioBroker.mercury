...
const translate = function (w){ // PLEASE HELP WITH THE TRANSLATION
    const word = {
        ...
        'totalEnergyActivePlus':               {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'totalEnergyActiveMinus':              {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'totalEnergyReactivePlus':             {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'totalEnergyReactiveMinus':            {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'currentYearTotalEnergyActivePlus':    {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'currentYearTotalEnergyActiveMinus':   {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'currentYearTotalEnergyReactivePlus':  {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'currentYearTotalEnergyReactiveMinus': {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'currentDayTotalEnergyActivePlus':     {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'currentDayTotalEnergyActiveMinus':    {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'currentDayTotalEnergyReactivePlus':   {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'currentDayTotalEnergyReactiveMinus':  {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'oneTarrifEnergyActivePlus':           {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'oneTarrifEnergyActiveMinus':          {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'oneTarrifEnergyReactivePlus':         {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'oneTarrifEnergyReactiveMinus':        {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'twoTarrifEnergyActivePlus':           {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'twoTarrifEnergyActiveMinus':          {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'twoTarrifEnergyReactivePlus':         {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'twoTarrifEnergyReactiveMinus':        {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'threeTarrifEnergyActivePlus':         {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'threeTarrifEnergyActiveMinus':        {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'threeTarrifEnergyReactivePlus':       {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'threeTarrifEnergyReactiveMinus':      {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'fourTarrifEnergyActivePlus':          {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'fourTarrifEnergyActiveMinus':         {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'fourTarrifEnergyReactivePlus':        {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
        'fourTarrifEnergyReactiveMinus':       {ru: 'ВАШ_ПЕРЕВОД', en: 'YOUR_TRANSLATION'},
...
const f = {
    ...
    currentPhase:     function (device, index, cmd, response){
        ...
        try {
            if (response.length === 12){
                //[CB 08 16 21 71 BA]
                //{"type":"Buffer","data":[203, 0,236,0, 0,243,0, 0,243,3, 10,39]}
...
const options = {
    protocol: {
        ...
        2: {
            ...
            fastpoll: [
                {code: 0x08, cmd: [0x16, 0x00], desc: 'Мощность по фазам P', func: f.powerPhaseP},
                {code: 0x08, cmd: [0x16, 0x08], desc: 'Мощность по фазам S', func: f.powerPhaseS},
...
function getThree32BE(response, divider){
    ...
    return {
        one:   parseFloat(((Buffer.from([0, 0, response[3], zeroConcat(response[2])]).readInt32BE(0)) / divider).toFixed(2)),
        two:   parseFloat(((Buffer.from([0, 0, response[6], zeroConcat(response[5])]).readInt32BE(0)) / divider).toFixed(2)),
        three: parseFloat(((Buffer.from([0, 0, response[9], zeroConcat(response[8])]).readInt32BE(0)) / divider).toFixed(2))
    };
}
...
function getFour32BE(response, divider){
    ...
    return {
        ...
        two:   parseFloat(((Buffer.from([0, 0, response[6], zeroConcat(response[5])]).readInt32BE(0)) / divider).toFixed(2)),
        three: parseFloat(((Buffer.from([0, 0, response[9], zeroConcat(response[8])]).readInt32BE(0)) / divider).toFixed(2)),
        four:  parseFloat(((Buffer.from([0, 0, response[12], zeroConcat(response[11])]).readInt32BE(0)) / divider).toFixed(2))
    };
}
