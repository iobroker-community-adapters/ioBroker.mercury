...
var f = {
    ...
    voltagePhase:     function (device, index, cmd, response){
        ...
        if (response.length === 12){
            ...
            setDevState(device, index, {name: 'metering.MainsParameters.voltagePhase1', desc: 'voltagePhase1', val: one});
            setDevState(device, index, {name: 'metering.MainsParameters.voltagePhase2', desc: 'voltagePhase2', val: two});
            setDevState(device, index, {name: 'metering.MainsParameters.voltagePhase3', desc: 'voltagePhase3', val: three});
    ...
    currentPhase:     function (device, index, cmd, response){
        ...
        if (response.length === 12){
            ...
            setDevState(device, index, {name: 'metering.MainsParameters.currentPhase1', desc: 'currentPhase1', val: one});
            setDevState(device, index, {name: 'metering.MainsParameters.currentPhase2', desc: 'currentPhase2', val: two});
            setDevState(device, index, {name: 'metering.MainsParameters.currentPhase3', desc: 'currentPhase3', val: three});
