...
const ff = {
    ...
    totalEnergy:      function (device, index, cmd, response){
        ...
        try {
            const t1 = +parseFloat(response[5].toString(16) + response[6].toString(16) + response[7].toString(16) + response[8].toString(16)).toFixed(2);
            const t2 = +parseFloat(response[9].toString(16) + response[10].toString(16) + response[11].toString(16) + response[12].toString(16)).toFixed(2);
            const t3 = +parseFloat(response[13].toString(16) + response[14].toString(16) + response[15].toString(16) + response[16].toString(16)).toFixed(2);
            const t4 = +parseFloat(response[17].toString(16) + response[18].toString(16) + response[19].toString(16) + response[20].toString(16)).toFixed(2);
            setDevState(device, index, {
    ...
    powerPhase:       function (device, index, cmd, response){
        ...
        try {
            if (response.length === 15){
                ...
                setDevState(device, index, {name: 'metering.MainsParameters.powerTotal', unit: 'kW', desc: 'powerTotal', val: one});
                setDevState(device, index, {name: 'metering.MainsParameters.powerPhase1',unit: 'kW', desc: 'powerPhase1', val: two});
                setDevState(device, index, {name: 'metering.MainsParameters.powerPhase2', unit: 'kW', desc: 'powerPhase2', val: three});
                setDevState(device, index, {name: 'metering.MainsParameters.powerPhase3', unit: 'kW', desc: 'powerPhase3', val: four});
            }
        } catch (e) {
            console.log(e);
        }
